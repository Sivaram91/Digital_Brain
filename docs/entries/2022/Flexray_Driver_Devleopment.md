...
This bare metal Flexray driver did not follow AUTOSAR standards, dint implement all AUTOSAR APIs, dint use joblist or interrupts and is not reusable as-is in other projects (That's the way it was intended to be developed)
